...
echo "Converting files in folder \"website\" to C Header file website.h"

WEBSITE="website/"
CURRDIR="$(pwd)"
OUTFILE="$CURRDIR/website.h"
...
cd $CURRDIR - See more at: http://www.esp8266.com/viewtopic.php?f=32&t=3780#sthash.2Du72osS.dpuf