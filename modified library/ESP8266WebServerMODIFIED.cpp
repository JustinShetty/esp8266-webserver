...
void ESP8266WebServer::send(int code, const String& content_type, const String& content, int content_length){
    String header;
    _prepareHeader(header, code, (const char*)content_type.c_str(), (size_t)content_length);
    sendContent(header);
